...
$lang['inf_acl_upload'] = "You don't have sufficient rights to store the original file on the wiki. So this file is not saved on the server.";
...
$lang['er_id'] = "Wrong use of this plugin. _odt2dw must be called with defined namepage (\$ID)";
